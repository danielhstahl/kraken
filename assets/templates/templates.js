...
templates['settings'] = template({"1":function(container,depth0,helpers,partials,data,blockParams,depths) {
    var alias1=container.lambda, alias2=container.escapeExpression;

  return "                <li class=\"mdl-menu__item\" onclick='"
    + alias2(alias1((depths[1] != null ? depths[1].selectFunction : depths[1]), depth0))
    + "(this)' data-value='"
  ...
  return "<div class='block-entries'>\n  <ul class=\"demo-list-control mdl-list fixed-width long-height\">\n    <li class=\"mdl-list__item\">\n      <span class=\"mdl-list__item-primary-content\">\n          <i class=\"material-icons large-icon mdl-color-text--orange-800 \">swap_horiz</i>\n          <span >\n              Auto-Rebalance\n          </span>\n      </span>\n      <span class=\"mdl-list__item-secondary-action\">\n        <label class=\"mdl-checkbox mdl-js-checkbox mdl-js-ripple-effect\" for=\"checkbox-1\">\n          <input type=\"checkbox\" id=\"checkbox-1\" class=\"mdl-checkbox__input\" checked />\n        </label>\n      </span>\n    </li>\n    <li class=\"mdl-list__item\">\n        <i class=\"material-icons  large-icon mdl-color-text--orange-800 \">vpn_key</i>\n        <div class=\"mdl-textfield mdl-js-textfield mdl-textfield--floating-label\">\n              <input class=\"mdl-textfield__input\" type=\"password\" id=\"key\">\n              <label class=\"mdl-textfield__label\" for=\"key\">Api Key</label>\n          </div>\n          <button id='submitkey' class='mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--accent' data-id='key' onclick='"
    ...
    + alias4(((helper = (helper = helpers["function"] || (depth0 != null ? depth0["function"] : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"function","hash":{},"data":data}) : helper)))
    + "(this)'>Submit</button>\n    </li>\n    <li class=\"mdl-list__item overflow\">\n      <i class=\"material-icons  large-icon mdl-color-text--orange-800\">attach_money</i>\n      <div class=\"mdl-textfield mdl-js-textfield mdl-textfield--floating-label getmdl-select\">\n            <input class=\"mdl-textfield__input\" type=\"text\" id=\"selectNumeraire\" value=\""
    + alias4(((helper = (helper = helpers.chosenNumeraire || (depth0 != null ? depth0.chosenNumeraire : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"chosenNumeraire","hash":{},"data":data}) : helper)))
    + "\" readonly tabIndex=\"-1\">\n            <label for=\"selectNumeraire\" data-mdl-for='selectNumeraire' class=\"mdl-textfield__label\">Select Numeraire</label>\n            <ul id='dropdown' for=\"selectNumeraire\" data-mdl-for='selectNumeraire' class=\"mdl-menu mdl-menu--bottom-left mdl-js-menu\">\n"
    + ((stack1 = helpers.each.call(alias1,(depth0 != null ? depth0.numeraire : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 0, blockParams, depths),"inverse":container.noop,"data":data})) != null ? stack1 : "")
    + "            </ul>\n        </div>\n    </li>\n  </ul>\n</div>\n";
